...
const TeamMemberAdd = (props: props): ReactElement => {
  const { show, onHide, Number } = props;
  ...
  const sendEmail = (e: { preventDefault: () => void }) => {
    ...
    dispatch(teamMailUser(body)).then(
      ...
      <Modal.Body className="TeamMemberAdd">
        <div>
          <div className="inputContainer">
            ...
            />
            <button onClick={addEmail} type="button" className="TeamMemAddBtn">
              추가
            </button>
          </div>
    ...
    <div className="ProjectAdd">
      ...
      <Modal.Footer>
        <div className="team_foot">
          ...
          <Button
            onClick={sendEmail}
            className="sendBtn btn btn-danger"
            disabled={deactive}
          >
            invite
          </Button>
