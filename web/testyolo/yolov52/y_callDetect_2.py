...
def callDetect(arg, save_root_dir_name , save_proj_Id, idx):
    ...
    #print(tmp2)
    callDetect: str = f'python ./testyolo/yolov5/detect.py --line-thickness 3 --save-txt --save-crop --source {arg} --weights ./testyolo/yolov5/car_model.pt  --project {save_root_dir_name} --name {save_proj_Id} --classes {tmp2}'
